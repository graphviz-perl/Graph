...
Returns an array (or reference in scalar context), each of its
elements is an annonymous array of vertices forming a maximal clique
in the graph. The implementation uses Bron-Kerbosch pivot algorithm.
